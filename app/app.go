...
import (
	...
	bluemodule "blue/x/blue"
	bluemodulekeeper "blue/x/blue/keeper"
	bluemoduletypes "blue/x/blue/types"
...
type App struct {
	*baseapp.BaseApp
	...
	BlueKeeper bluemodulekeeper.Keeper
...
func New(
	...
	app.BlueKeeper = *bluemodulekeeper.NewKeeper(
		appCodec,
		keys[bluemoduletypes.StoreKey],
		keys[bluemoduletypes.MemStoreKey],
		app.GetSubspace(bluemoduletypes.ModuleName),
	)
	blueModule := bluemodule.NewAppModule(appCodec, app.BlueKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(bluemoduletypes.ModuleName)
