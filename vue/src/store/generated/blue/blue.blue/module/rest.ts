 ...
 */
export type BlueParams = object;

export interface BluePool {
  owner?: string;
 ...
 */
export interface BlueQueryParamsResponse {
  /** params holds all the parameters of this module. */
  params?: BlueParams;
}

export interface BlueQueryPoolsResponse {
  Pool?: BluePool[];
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/blue/blue/params
   */
  queryParams = (params: RequestParams = {}) =>
    this.request<BlueQueryParamsResponse, RpcStatus>({
      path: `/blue/blue/params`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @tags Query
   * @name QueryPools
   * @summary Queries a list of Pools items.
   * @request GET:/blue/blue/pools
   */
  queryPools = (
    query?: {
    ...
    this.request<BlueQueryPoolsResponse, RpcStatus>({
